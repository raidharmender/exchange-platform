# Exchange Platform - Comprehensive Testing Guide
...
For interactive API documentation, see the [Swagger Documentation](Swagger.md).
...
```bash
# Get specific order
curl -X GET "http://localhost:8080/api/v1/orders/orders/{id}"

# Cancel order
curl -X PUT "http://localhost:8080/api/v1/orders/orders/{id}/cancel"

# Get order trades
curl -X GET "http://localhost:8080/api/v1/orders/orders/{id}/trades"
```

### Testing Tools
- **Swagger UI**: `http://localhost:8080/swagger-ui` - Interactive testing
- **curl**: Command-line testing (examples above)
- **Postman**: Set base URL to `http://localhost:8080/api/v1`
- **JavaScript/Fetch**: See [Swagger Documentation](Swagger.md) for examples
